...
const Icons = (function () {
  ...
  const paths = {
    ...
    keyboard:
      '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 7a2 2 0 012-2h14a2 2 0 012 2v10a2 2 0 01-2 2H5a2 2 0 01-2-2V7zm4 3h.01M12 10h.01M17 10h.01M7 14h10"></path>',
    ...
    // Training mode icon (refresh/cycle)
    training:
  ...
  const customViewBoxIcons = {
    // Exam/Writing icon (pen/paper)
    exam: {
      viewBox: '0 0 488 488',
      path: '<path fill="currentColor" d="M484.685,196.177c-4-3.8-10.3-3.7-14.1,0.3l-181,189.6l-14.1-57.6l188.8-189.7c3.9-3.9,3.9-10.2,0-14.1c-3.9-3.9-10.2-3.9-14.1,0l-188.8,189.6l-70.3-17.7l-17.7-70.3l189.6-188.8c3.9-3.9,3.9-10.2,0-14.1c-3.9-3.9-10.2-3.9-14.1,0l-189.6,188.9l-57.6-14.1l189.6-181c4-3.8,4.1-10.1,0.3-14.1s-10.1-4.1-14.1-0.3l-202.7,193.6l-0.1,0.1c-0.3,0.2-0.5,0.5-0.7,0.8c-0.1,0.1-0.1,0.1-0.2,0.2c-0.3,0.3-0.5,0.7-0.7,1v0.1c-0.2,0.3-0.4,0.7-0.5,1c0,0.1-0.1,0.2-0.1,0.3c-0.1,0.3-0.2,0.6-0.3,1c0,0.1,0,0.1-0.1,0.2l-71.6,274.4c-0.9,3.4,0.1,7.1,2.6,9.6c1.9,1.9,4.5,2.9,7.1,2.9c0.8,0,1.7-0.1,2.5-0.3l274.4-71.6c0.1,0,0.1,0,0.2-0.1c0.3-0.1,0.6-0.2,1-0.3c0.1,0,0.2-0.1,0.3-0.1c0.3-0.2,0.7-0.3,1-0.5h0.1c0.4-0.2,0.7-0.5,1-0.7c0.1-0.1,0.1-0.1,0.2-0.2c0.3-0.2,0.5-0.5,0.8-0.7l0.1-0.1l193.6-202.7C488.785,206.277,488.685,199.977,484.685,196.177zM23.785,463.777l18.7-71.7l53,53L23.785,463.777zM117.885,439.277l-69.6-69.6l40.3-154.2l65.4,16l19.1,75.7c0.9,3.6,3.7,6.4,7.3,7.3h0l75.7,19.1l16,65.4L117.885,439.277z"/>'
    },
    fire: {
    ...
    achievement: {
      viewBox: '0 0 64 64',
      path: '<path fill="currentColor" d="M51.93,59.08l-7.28-25.43C48.54,30.17,51,25.13,51,19.5c0-10.49-8.51-19-19-19s-19,8.51-19,19c0,5.61,2.45,10.64,6.31,14.12l-7.24,25.3c-.12.4.03.83.36,1.08.33.25.79.26,1.14.04l6.68-4.28,3.65,7.04c.17.33.52.54.89.54.04,0,.07,0,.11-.01.41-.04.75-.34.86-.74l6.23-23.26,6.27,23.42c.11.4.45.69.86.74.04,0,.07,0,.11,0,.37,0,.71-.21.89-.54l3.65-7.04,6.68,4.28c.35.22.8.21,1.14-.04.33-.25.47-.68.36-1.08zM15,19.5c0-9.37,7.63-17,17-17s17,7.63,17,17-7.63,17-17,17S15,28.87,15,19.5zm9.48,40.09l-2.96-5.73c-.13-.25-.36-.43-.63-.51-.27-.07-.56-.03-.8.12l-5.37,3.44,6.28-21.95c2.63,1.88,5.76,3.1,9.15,3.43l-5.67,21.2zm19.43-6.05l-5.37-3.44c-.24-.15-.53-.2-.8-.12-.27.07-.5.26-.63.51l-2.96,5.73-5.72-21.34c3.39-.32,6.52-1.54,9.16-3.41l6.32,22.08z M32,31.5c6.63,0,12-5.37,12-12s-5.37-12-12-12-12,5.37-12,12,5.37,12,12,12zm0-22c5.51,0,10,4.49,10,10s-4.49,10-10,10-10-4.49-10-10,4.49-10,10-10z"/>'
    }
  };
