...
function initOfflineIndicator() {
  ...
  indicator.className =
    'fixed bottom-4 left-4 z-50 flex items-center gap-2 px-4 py-2 bg-amber-500 text-white text-sm font-medium rounded-lg shadow-lg transform transition-all duration-300 translate-y-20 opacity-0';
  indicator.innerHTML = `
