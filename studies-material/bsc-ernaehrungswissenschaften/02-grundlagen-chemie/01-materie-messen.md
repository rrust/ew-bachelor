...
* [cite_start]**Massenerhaltungssatz:** Während einer chemischen Reaktion findet keine beobachtbare Veränderung der Gesamtmasse statt; die Masse der Edukte entspricht der Masse der Produkte [cite: 59-62].
* [cite_start]**Energieerhaltungssatz:** In einem abgeschlossenen System kann Energie weder erzeugt noch vernichtet werden [cite: 63-64]. Sie kann lediglich zwischen verschiedenen Formen umgewandelt werden, etwa von Bewegungsenergie (kinetischer Energie) in Wärmeenergie.
* **Äquivalenz von Masse und Energie:** Die kombinierte Menge von Masse und Energie im Universum ist fixiert. Dieser Zusammenhang wird durch Einsteins berühmte Gleichung ausgedrückt:
    $$E=mc^{2}$$
    [cite_start][cite: 66-67].
...
> **Beispiel Koffein:**
> [cite_start]Die molekulare Formel $C_{8}H_{10}N_{4}O_{2}$ zeigt an, dass ein Molekül Koffein aus 8 Kohlenstoff-, 10 Wasserstoff-, 4 Stickstoff- und 2 Sauerstoffatomen besteht[cite: 221].

Wenn Elemente reagieren, bilden sie Verbindungen mit völlig neuen Eigenschaften. [cite_start]Reagiert beispielsweise festes Natrium (Na) mit Chlorgas ($Cl_2$), entsteht festes Natriumchlorid (NaCl), unser Speisesalz [cite: 224-230]. Ebenso reagieren Aluminium und Brom heftig miteinander.
...
* *Submikroskopisch:* Wir stellen uns Wassermoleküle vor. Im Feststoff sind sie in einem Gitter angeordnet, in der Flüssigkeit beweglich aber nah beieinander, im Gas weit voneinander entfernt.
* *Reaktion:* Wenn Wasserstoff ($H_2$) und Sauerstoff ($O_2$) in einem Ballon reagieren (Knallgasreaktion), sehen wir makroskopisch eine Explosion. Submikroskopisch ordnen sich die H- und O-Atome neu an, um $H_2O$-Moleküle zu bilden. [cite_start]Symbolisch schreiben wir: $2~H_{2}(g)+O_{2}(g) \rightarrow 2~H_{2}O(g)$[cite: 269].

---

## 4. Aggregatzustände und Eigenschaften von Materie
...
* **Mischungen:** Bestehen aus zwei oder mehr Substanzen.
    * *Homogene Mischung (Lösung):* Die Komponenten sind nicht unterscheidbar (z.B. Zuckerwasser, Luft).
    * *Heterogene Mischung:* Die unterschiedlichen Teile sind erkennbar (z.B. Sand und Eisenpulver, Öl in Wasser).
...
[cite_start]Beispiele für Dichten bei Raumtemperatur [cite: 346-347]:
* Aluminium: $2.7~g/cm^{3}$ (leicht)
* Quecksilber: $13.6~g/cm^{3}$ (sehr dicht für eine Flüssigkeit)
* Platin: $21.5~g/cm^{3}$ (extrem dicht)

> [cite_start]**Rechenbeispiel 1: Dichte von Kupfer** [cite: 391-410]
> *Gegeben:* Ein Stück Kupfer mit Masse 57.54 g. Dimensionen: 9.36 cm lang, 7.23 cm breit, 0.95 mm dick.
...
> *Gegeben:* 95 mL Quecksilber (Hg), Dichte $13.6~g/cm^{3}$.
> *Gesucht:* Masse in Gramm.
> *Wissen:* $1~mL = 1~cm^{3}$.
>
> *Lösungsweg:* Wir nutzen die Dichte als Umrechnungsfaktor.
> $95~cm^{3} \times 13.6~\frac{g}{cm^{3}} = 1292~g$.
...
* Zeit: Sekunden (s)
* [cite_start]Temperatur: Kelvin (K) [cite: 453-462].

[cite_start]Um sehr große oder kleine Zahlen zu vermeiden, nutzen wir **metrische Vorsilben** [cite: 475-507]:
* Giga (G): $10^9$
* Mega (M): $10^6$
* Kilo (k): $10^3$
* Zenti (c): $10^{-2}$
...
* **Gefrierpunkt:** $32^{\circ}F$ / $0^{\circ}C$ / $273~K$

Die Umrechnung zwischen Celsius und Kelvin ist simpel, da die Schrittweite identisch ist (1 Grad Celsius = 1 Kelvin Einheit). Der Unterschied liegt im Nullpunkt:
$$T(K) = t(^{\circ}C) + 273.15$$
[cite_start][cite: 593].
[cite_start]*Beispiel flüssiger Stickstoff:* $-196^{\circ}C + 273.15 = 77~K$[cite: 595].
...
* Treffer eng beieinander, aber weit weg von der Mitte: Präzise, aber nicht genau (Systematischer Fehler).
* Treffer eng beieinander und in der Mitte: Genau und präzise.

Der **prozentuale Fehler** berechnet sich als:
$$\frac{Experimenteller~Wert - Anerkannter~Wert}{Anerkannter~Wert} \times 100\%$$
[cite_start][cite: 692].
...
* [cite_start]**Multiplikation/Division:** Das Ergebnis darf nicht mehr signifikante Stellen haben als der Faktor mit den *wenigsten* signifikanten Stellen[cite: 761].
    * $4.242 \times 1.23 = 5.21766... \rightarrow$ Runden auf **5.22** (da 1.23 nur 3 Stellen hat).
* [cite_start]**Addition/Subtraktion:** Das Ergebnis richtet sich nach der Zahl mit den wenigsten *Nachkommastellen*[cite: 775].
...
> **Beispiel:** Wandle $2.61 \times 10^4~mm^2$ in $m^2$ um.
> *Falsch:* Einfach durch 1000 teilen.
> *Richtig:* Den Faktor $(\frac{1~m}{1000~mm})$ quadrieren $\rightarrow (\frac{1^2~m^2}{1000^2~mm^2}) = \frac{1~m^2}{1.000.000~mm^2}$.
>
> [cite_start]Rechnung: $2.61 \times 10^4~mm^2 \times \frac{1~m^2}{10^6~mm^2} = 2.61 \times 10^{-2}~m^2$ [cite: 833-834].

Dasselbe gilt für Volumen (hoch 3):
$2.61~m^3$ in $cm^3$: Wir nutzen $(\frac{100~cm}{1~m})^3 = 1.000.000$.
[cite_start]Ergebnis: $2.61 \times 10^6~cm^3$ [cite: 840-842].
