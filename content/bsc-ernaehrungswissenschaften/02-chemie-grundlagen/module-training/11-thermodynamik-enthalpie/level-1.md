...
level: 1
question: 'Was ist Thermodynamik?'
options:
...
correctAnswer: 'Die Lehre von Energieänderungen bei chemischen Reaktionen'
...
correctAnswer: 'Die Wärmeenergie eines Systems bei konstantem Druck'
...
correctAnswer: 'Die Reaktion ist exotherm (gibt Wärme ab)'
...
correctAnswer: 'Die Reaktion ist endotherm (nimmt Wärme auf)'
...
topic: 'Thermodynamik & Enthalpie'
level: 1
question: 'Was ist die Standardbildungsenthalpie?'
options:
...
correctAnswer: 'Die Enthalpieänderung bei der Bildung von 1 mol einer Verbindung aus den Elementen unter Standardbedingungen'
...
topic: 'Thermodynamik & Enthalpie'
level: 1
question: 'Was sind Standardbedingungen in der Thermodynamik?'
options:
  - '25°C (298 K) und 1 bar (oder 1 atm)'
  - '0°C und 1 atm'
  - '100°C und 1 bar'
  - 'Beliebige Temperatur und Druck'
correctAnswer: '25°C (298 K) und 1 bar (oder 1 atm)'
...
topic: 'Thermodynamik & Enthalpie'
level: 1
question: 'Was ist die Standardbildungsenthalpie eines Elements in seinem stabilsten Zustand?'
options:
  - 'Ein positiver Wert'
  - 'Ein negativer Wert'
...
topic: 'Thermodynamik & Enthalpie'
level: 1
question: 'Was ist ein Kalorimeter?'
options:
...
correctAnswer: 'Ein Gerät zur Messung von Wärmemengen'
...
correctAnswer: 'Energie kann weder erzeugt noch vernichtet werden'
...
topic: 'Thermodynamik & Enthalpie'
level: 1
question: 'Was ist die Reaktionsenthalpie (ΔHᵣ)?'
options:
...
correctAnswer: 'Die Summe der Enthalpien der Produkte minus der Summe der Enthalpien der Reaktanten'
