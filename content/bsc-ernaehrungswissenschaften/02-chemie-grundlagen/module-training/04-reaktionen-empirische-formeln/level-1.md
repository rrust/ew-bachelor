...
level: 1
question: 'Was ist eine Synthesereaktion?'
options:
...
correctAnswer: 'Eine Reaktion, bei der mehrere Stoffe zu einem Produkt reagieren'
...
topic: 'Reaktionen & Empirische Formeln'
level: 1
question: 'Was versteht man unter einer Summenformel?'
options:
...
correctAnswer: 'Die Anzahl und Art der Atome in einem Molekül'
...
topic: 'Reaktionen & Empirische Formeln'
level: 1
question: 'Was ist die empirische Formel (Verhältnisformel)?'
options:
...
correctAnswer: 'Das kleinstmögliche ganzzahlige Verhältnis der Atome'
...
topic: 'Reaktionen & Empirische Formeln'
level: 1
question: 'Was versteht man unter einer Einfach-Austauschreaktion?'
options:
  - 'Ein Stoff zerfällt in seine Elemente'
  - 'Zwei Verbindungen tauschen Bestandteile aus'
  - 'Ein Element ersetzt ein anderes in einer Verbindung'
  - 'Mehrere Elemente verbinden sich'
correctAnswer: 'Ein Element ersetzt ein anderes in einer Verbindung'
...
topic: 'Reaktionen & Empirische Formeln'
level: 1
question: 'Was ist eine Doppel-Austauschreaktion (Metathese)?'
options:
  - 'Zwei Verbindungen tauschen gegenseitig Bestandteile aus'
  - 'Ein Element ersetzt ein anderes'
  - 'Ein Stoff verbrennt'
  - 'Ein Molekül zerfällt'
correctAnswer: 'Zwei Verbindungen tauschen gegenseitig Bestandteile aus'
...
topic: 'Reaktionen & Empirische Formeln'
level: 1
question: 'Was beschreibt die prozentuale Zusammensetzung einer Verbindung?'
options:
...
correctAnswer: 'Den Massenanteil jedes Elements in Prozent'
...
correctAnswer: 'Eine Reaktion, bei der ein schwerlöslicher Feststoff ausfällt'
...
topic: 'Reaktionen & Empirische Formeln'
level: 1
question: 'Was unterscheidet die Molekülformel von der empirischen Formel?'
options:
...
correctAnswer: 'Die Molekülformel zeigt die tatsächliche Atomanzahl, die empirische das kleinste ganzzahlige Verhältnis'
