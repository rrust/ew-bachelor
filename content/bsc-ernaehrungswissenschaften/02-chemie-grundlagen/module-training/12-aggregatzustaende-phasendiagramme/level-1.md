...
level: 1
question: 'Welche drei Aggregatzustände gibt es?'
options:
...
correctAnswer: 'Die Temperatur, bei der ein Stoff von fest zu flüssig übergeht'
...
correctAnswer: 'Die Temperatur, bei der der Dampfdruck gleich dem äußeren Druck ist'
...
correctAnswer: 'Übergang von fest zu gasförmig ohne flüssige Phase'
...
correctAnswer: 'Eine grafische Darstellung der Zustände eines Stoffes in Abhängigkeit von Druck und Temperatur'
...
topic: 'Aggregatzustände & Phasendiagramme'
level: 1
question: 'Was ist der Tripelpunkt?'
options:
...
correctAnswer: 'Der Punkt, an dem alle drei Aggregatzustände im Gleichgewicht sind'
...
topic: 'Aggregatzustände & Phasendiagramme'
level: 1
question: 'Was ist der kritische Punkt?'
options:
...
correctAnswer: 'Der Punkt, oberhalb dessen keine Unterscheidung zwischen flüssig und gasförmig möglich ist'
...
topic: 'Aggregatzustände & Phasendiagramme'
level: 1
question: 'Was ist Verdampfung?'
options:
  - 'Übergang von fest zu gasförmig'
  - 'Übergang von fest zu flüssig'
  - 'Übergang von gasförmig zu fest'
  - 'Übergang von flüssig zu gasförmig'
correctAnswer: 'Übergang von flüssig zu gasförmig'
...
options:
  ...
  - 'Übergang von fest zu gasförmig'
  - 'Übergang von flüssig zu gasförmig'
correctAnswer: 'Übergang von gasförmig zu flüssig'
...
topic: 'Aggregatzustände & Phasendiagramme'
level: 1
question: 'Was ist Resublimation (Deposition)?'
options:
  - 'Übergang von flüssig zu gasförmig'
  - 'Übergang von gasförmig zu fest ohne flüssige Phase'
  - 'Übergang von fest zu flüssig'
  - 'Übergang von flüssig zu fest'
correctAnswer: 'Übergang von gasförmig zu fest ohne flüssige Phase'
