...
level: 1
question: 'Was sind kolligative Eigenschaften?'
options:
...
correctAnswer: 'Eigenschaften, die nur von der Anzahl der gelösten Teilchen abhängen, nicht von ihrer Art'
...
topic: 'Kolligative Eigenschaften'
level: 1
question: 'Welche der folgenden ist eine kolligative Eigenschaft?'
options:
  - 'Leitfähigkeit'
  - 'Farbe der Lösung'
  - 'Dichte der Lösung'
  - 'Siedepunkterhöhung'
correctAnswer: 'Siedepunkterhöhung'
...
topic: 'Kolligative Eigenschaften'
level: 1
question: 'Was ist die Gefrierpunktserniedrigung?'
options:
...
correctAnswer: 'Die Senkung des Gefrierpunkts einer Lösung gegenüber dem reinen Lösungsmittel'
...
topic: 'Kolligative Eigenschaften'
level: 1
question: 'Was ist die Siedepunkterhöhung?'
options:
...
correctAnswer: 'Die Erhöhung des Siedepunkts einer Lösung gegenüber dem reinen Lösungsmittel'
...
correctAnswer: 'Der Übergang von Lösungsmittel durch eine semipermeable Membran'
...
topic: 'Kolligative Eigenschaften'
level: 1
question: 'Was ist die Dampfdruckerniedrigung?'
options:
...
correctAnswer: 'Die Senkung des Dampfdrucks eines Lösungsmittels durch einen gelösten Stoff'
...
topic: 'Kolligative Eigenschaften'
level: 1
question: 'Was ist eine semipermeable Membran?'
options:
...
correctAnswer: 'Eine Membran, die nur bestimmte Teilchen durchlässt'
...
correctAnswer: 'Mol gelöster Stoff pro Kilogramm Lösungsmittel'
